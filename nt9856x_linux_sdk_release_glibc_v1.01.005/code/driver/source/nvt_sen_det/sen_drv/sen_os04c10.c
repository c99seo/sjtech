...
static void sen_ext_get_probe_sen_os04c10(CTL_SEN_ID id, CTL_SENDRV_GET_PROBE_SEN_PARAM *data);
...
static ER sen_get_info_os04c10(CTL_SEN_ID id, CTL_SENDRV_CFGID drv_cfg_id, void *data)
{
    ...
    case CTL_SENDRV_CFGID_GET_PROBE_SEN:
        sen_ext_get_probe_sen_os04c10(id, (CTL_SENDRV_GET_PROBE_SEN_PARAM *)(data));
        break;
/*
...
static void sen_ext_get_probe_sen_os04c10(CTL_SEN_ID id, CTL_SENDRV_GET_PROBE_SEN_PARAM *data)
{
    ...
    cmd = sen_set_cmd_info_os04c10(0x300a, 1,0x0, 0x0);
    rt |= sen_read_reg_os04c10(id, &cmd);
    ...
    cmd = sen_set_cmd_info_os04c10(0x300b, 1, 0x0, 0x0);
    rt |= sen_read_reg_os04c10(id, &cmd);
    ...
    cmd = sen_set_cmd_info_os04c10(0x300c,1, 0x0, 0x0);
    rt |= sen_read_reg_os04c10(id, &cmd);
