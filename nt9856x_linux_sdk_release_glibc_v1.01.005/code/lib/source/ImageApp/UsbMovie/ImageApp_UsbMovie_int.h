...
typedef struct {
	...
	HD_IN_ID             vproc_i[1];
	HD_OUT_ID            vproc_o_phy[3];
	HD_PATH_ID           vproc_p_phy[3];
	HD_OUT_ID            vproc_o[2];
	HD_PATH_ID           vproc_p[2];
	// video encode
	HD_IN_ID             venc_i[2];
	HD_OUT_ID            venc_o[2];
	HD_PATH_ID           venc_p[2];
...
extern HD_VIDEOPROC_OUT usbimg_vproc_param[MAX_USBIMG_PATH][3];
extern HD_VIDEOPROC_OUT_EX usbimg_vproc_param_ex[MAX_USBIMG_PATH][2];
extern UINT32 usbimg_vproc_func[MAX_USBIMG_PATH];
extern HD_VIDEOENC_PATH_CONFIG usbimg_venc_path_cfg[MAX_USBIMG_PATH][2];
extern HD_VIDEOENC_IN  usbimg_venc_in_param[MAX_USBIMG_PATH][2];
extern HD_VIDEOENC_OUT2 usbimg_venc_out_param[MAX_USBIMG_PATH][2];
extern HD_H26XENC_RATE_CONTROL2 usbimg_venc_rc_param[MAX_USBIMG_PATH][2];
extern HD_VIDEOENC_BUFINFO usbimg_venc_bs_buf[MAX_USBIMG_PATH][2];
