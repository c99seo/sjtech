...
#define BSMUX_MAX_CTRL_NUM      12 //NMR_MAX_TOTALMDAT
...
#define BSMUX_VIDEO_DESC_SIZE   0x100   // 256 bytes //NMTMDAT_VIDEO_DESC_SIZE
...
#define BSMUX_TEST_THUMB        1
#define BSMUX_TEST_MULTI_TILE   0
...
typedef UINT32 BSMUX_ENG_COPY(UINT32 uiDst, void * uiSrc, UINT32 uiSize);
