...
#define UVAC_VID_EP_PACK_SIZE_MAX_CNT                   4
...
#define UVAC_CFGA_CFG_ATTRIBUES          0x80            /* characteristics                  */
#define UVAC_CFGA_MAX_POWER              0xFA            /* maximum power in 500mA           */
...
#if 1
#define UVC_VC_CLOCK_FREQUENCY              0x01C9C380   // dwClockFrequency of  :30MHz
#else
...
#define UVC_ISOIN_FS_PACKET_SIZE            512  // < 0x800
...
extern UINT8 g_UVACFSOtherConfigDescFBH264[], g_U2UVACHSOtherConfigDescFBH264[];
...
extern const UINT8 USBVideoBOSDescriptor[];

extern UINT16 U2UVAC_MakeHSConfigDesc(UINT8 *pUvacHSConfigDesc, UINT16 maxLen);
extern UINT16 UVAC_MakeOtherConfigDesc(UINT8 *pUvacOtherConfigDesc, UINT16 maxLen);
//=============================
...
extern UINT16 gU2UvacVidEPMaxPackSize[UVAC_VID_EP_PACK_SIZE_MAX_CNT];
#endif
