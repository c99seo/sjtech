...
#define UVAC_MAX_PAYLOAD_FRAME_SIZE (900*1024)    //800k
...
extern USB_EP_BLKNUM gU2UvcIsoInBandWidth[UVAC_VID_DEV_CNT_MAX];
extern UINT32 gU2UvcIsoInHsPacketSize[UVAC_VID_DEV_CNT_MAX];


extern UINT32 *p_uvc_mjpg_max_tx_size[UVAC_VID_DEV_CNT_MAX];
extern UINT32 *p_uvc_h264_max_tx_size[UVAC_VID_DEV_CNT_MAX];
extern UINT32 *p_uvc_yuv_max_tx_size[UVAC_VID_DEV_CNT_MAX];
extern UINT32 uvc_mjpg_max_tx_size_cnt[UVAC_VID_DEV_CNT_MAX];
extern UINT32 uvc_h264_max_tx_size_cnt[UVAC_VID_DEV_CNT_MAX];
extern UINT32 uvc_yuv_max_tx_size_cnt[UVAC_VID_DEV_CNT_MAX];
/*-----------------------------------
    functions declare
-----------------------------------*/
...
extern UINT8 U2UVAC_GetUnitID(UVC_UNIT_TYPE unit);
extern ER U2UVAC_WriteIntData(UINT8 *pBuf, UINT32 *pBufSize);
