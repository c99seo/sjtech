#!/bin/bash
# global settings
KEEP_SENSOR_LIST=(sen_imx290 sen_sc401ai sen_os02k10 sen_os05a10 sen_gc4653)
KEEP_ISP_CFG=(isp_imx290_0.cfg isp_imx290_0_hdr.cfg isp_gc4653_0.cfg isp_os05a10_0.cfg isp_sc401ai_0.cfg)
