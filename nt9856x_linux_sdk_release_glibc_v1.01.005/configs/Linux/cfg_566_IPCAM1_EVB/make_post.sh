#!/bin/bash
# global settings
KEEP_SENSOR_LIST=(sen_imx290 sen_sc401ai sen_os02k10 sen_os05a10 sen_gc4653 sen_imx317 sen_imx335)
KEEP_ISP_CFG=(isp_imx290_0.cfg isp_imx290_0_hdr.cfg isp_gc4653_0.cfg isp_os05a10_0.cfg isp_sc401ai_0.cfg isp_imx317_0.cfg isp_imx335_0.cfg)
...
do
	cp ${NVT_HDAL_DIR}/ext_devices/sensor/configs/cfg/${n}_56x.cfg ${SENSOR_CFG_DIR}
